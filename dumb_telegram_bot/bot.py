...
LOGGER.info(bot.__str__)
DATABASE = LocalPandasDatabase(path="./data/result.json")
...
def mimic(message):
    ...
    text_samples = DATABASE.get_sample_from_user(n_samples=300, username=telegram_username)
